 ...
 * Generated at: 2021-06-25 12:00:59 UTC
...
public final class table_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\turl: '/api/stud?method=findAllStudentInfo',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\tfield: 'classid',\r\n");
      out.write("\t\t\t\t\t\t\t\twidth: 110,\r\n");
      out.write("\t\t\t\t\t\t\t\ttitle: '班级'\r\n");
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\tfield: 'cellphone',\r\n");
      out.write("\t\t\t\t\t\t\t\twidth: 120,\r\n");
      out.write("\t\t\t\t\t\t\t\ttitle: '手机号'\r\n");
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\tfield: 'dormid',\r\n");
      out.write("\t\t\t\t\t\t\t\twidth: 100,\r\n");
      out.write("\t\t\t\t\t\t\t\ttitle: '寝室号'\r\n");
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\tfield: 'birthdata',\r\n");
      out.write("\t\t\t\t\t\t\t\twidth: 140,\r\n");
      out.write("\t\t\t\t\t\t\t\ttitle: '出身日期'\r\n");
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t{\r\n");
      ...
      out.write("\t\t\t\t\t\tvar path = \"/api/stud?method=search&page=1&limit=10\";\r\n");
      out.write("\t\t\t\t\t\tif(data.field.username != ''){\r\n");
      out.write("\t\t\t\t\t\t\tpath += (\"&username=\" + data.field.username);\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\tif(data.field.sid != ''){\r\n");
      out.write("\t\t\t\t\t\t\tpath += (\"&sid=\"+parseInt(data.field.sid));\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\tsearchStuInfo(path,table);\r\n");
      out.write("\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t */\r\n");
      out.write("\t\t\t\tvar deleteStuInfoTrs = new Array();\r\n");
      ...
      out.write("\t\t\t\t\t\t\tarea: ['60%', '90%'],\r\n");
      out.write("\t\t\t\t\t\t\tcontent: '../page/table/add.jsp',\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvar path = \"/api/stud?method=deleteStuInfById&id=\" + data[i].id\r\n");
      out.write("\t\t\t\t\t\t\t\tdeleteStuInfoById(path);\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\tfor(var i=0;i<deleteStuInfoTrs.length;i++){\r\n");
      out.write("\t\t\t\t\t\t\t\tdeleteStuInfoTrs[i].del()\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\tdeleteStuInfoTrs[deleteStuInfoTrs.length] = obj;\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t//单个用户的操作\r\n");
      ...
      out.write("\t\t\t\t\t\t\tcontent: '../page/table/edit.jsp?name=' + dataOb.id,\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t$(window).on(\"resize\", function() {\r\n");
      out.write("\t\t\t\t\t\t\tlayer.full(index);\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      ...
      out.write("\t\t\t\t\t\tlayer.confirm('真的删除行么', function(index) {\r\n");
      out.write("\t\t\t\t\t\t\tvar path = \"/api/stud?method=deleteStuInfById&id=\" + dataOb.id\r\n");
      out.write("\t\t\t\t\t\t\tdeleteStuInfoById(path);\r\n");
      out.write("\t\t\t\t\t\t\tobj.del();\r\n");
      out.write("\t\t\t\t\t\t\tlayer.close(index);\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      ...
      out.write("\t\t\t\t\t\t\t'city': 'E',\r\n");
      out.write("\t\t\t\t\t\t\t'classid': 'F',\r\n");
      out.write("\t\t\t\t\t\t\t'cellphone': 'G',\r\n");
      out.write("\t\t\t\t\t\t\t'dormid': 'H',\r\n");
      out.write("\t\t\t\t\t\t\t'birthData': 'I',\r\n");
      out.write("\t\t\t\t\t\t\t'status': 'J'\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\"sex\":object.sex,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\"city\":object.city,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\"classid\":object.classid.toString(),\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\"cellphone\":object.cellphone.toString(),\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\"dormid\":object.dormid.toString(),\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\"birthdata\":object.birthData,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\"status\":sta\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\tvar id = object.id;\r\n");
      out.write("\t\t\t\t\t\t\t\tconsole.log(JSON.stringify(newStuInfo));\r\n");
      out.write("\t\t\t\t\t\t\t\tif (id == \"ID\") { } else {\r\n");
      ...
      out.write("\t\t\t */\r\n");
      out.write("\t\t\tfunction deleteStuInfoById(path) {\r\n");
      out.write("\t\t\t\tpostNotData(path).then(result => {\r\n");
      out.write("\t\t\t\t})\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfunction insertStuInfo(data){\r\n");
      out.write("\t\t\t\tpostHasData(\"/api/stud?method=insertStuInfo\",data).then(result => {\r\n");
      out.write("\t\t\t\t})\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfunction searchStuInfo(path,table){\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /page/table.jsp(3,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fredirect_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /page/table.jsp(4,2) name = url type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
